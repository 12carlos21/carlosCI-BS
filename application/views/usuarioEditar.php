<div class="row">
    ...
    <div class="col-lg-6 col-md-6 col-6">
        ...
        <div class="form-group">
            ...
            <input type="text" value="<?php echo $usuarioEditar[0]->idusuario; ?>" class="hide" name="idusuario" placeholder="idusuario"/><p></p>

            <input type="text" value="<?php echo $usuarioEditar[0]->nomeUsuario; ?>" class="form-control form-control-lg" name="nomeUsuario" placeholder="Nomeusuario" required/><p></p>

            <input type="text" value="<?php echo $usuarioEditar[0]->user; ?>" class="form-control form-control-lg" name="user" placeholder="User" required/><p></p>
