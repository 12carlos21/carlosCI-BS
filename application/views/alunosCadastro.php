    ...
    <div class="col-lg-6 col-md-6 col-6">
            <form method="post" style="text-align: center;" class="form-group">
                    ...
                    <div class="form-group">
                            ...
                            <input name = "update" type = "submit" id = "update" value = "Atualizar" class="btn btn-warning">  <p>
                    <div class="form-group">	
                            <input type="text" class="form-control" name="nome" placeholder="Digite o nome ..." >
                    </div>
                            <input name="pesquisar" type="submit" value="Pesquisar" class="btn btn-primary"> <p></p>

                            <input name="todos" type="submit" value="Listar Todos" class="btn btn-success"> <p></p>
            </form>
    </div>
    <div class="col-lg-3 col-md-3 col-3"></div>
</div>